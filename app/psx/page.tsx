...
const features = [
  {
    ...
    description:
      "Understand the basic concepts, structure and key participants of the stock market.",
  },
  {
    icon: LineChart,
  ...
  },
  {
    ...
    description:
      "Develop awareness of risk management and responsible market participation.",
  },
];
              ...
              <div className="rounded-[24px] border border-white/10 bg-slate-900 p-6">
                ...
                <div className="mt-7 rounded-2xl border border-white/10 bg-white/[0.03] p-5">
                  ...
                  <div className="mt-7 flex h-32 items-end gap-2">
                    ...
                    {[35, 48, 42, 61, 55, 72, 67, 86, 76, 94].map(
                      (height, index) => (
                        <motion.div
                          key={index}
                          initial={{ height: 0 }}
            ...
            >
              ...
              <div className="rounded-[30px] border border-slate-200 bg-slate-50 p-7 sm:p-9">
                ...
                <p className="mt-4 text-sm leading-7 text-slate-600">
                  Develop an understanding of market concepts, financial
                  information and risk awareness before making decisions
                  in the stock market.
                </p>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex h-13 w-13 items-center justify-center rounded-2xl bg-white text-blue-600 shadow-sm transition-all duration-300 group-hover:bg-blue-600 group-hover:text-white">
                    <Icon size={26} />
                  </div>
