...
const features = [
  {
    ...
    description:
      "Learn how to identify relevant keywords and understand the intent behind online searches.",
  },
  {
    icon: Target,
    title: "On-Page SEO",
    description:
      "Understand content optimization, page structure, titles and essential on-page SEO elements.",
  },
  {
    icon: BarChart3,
    title: "SEO Analytics",
    description:
      "Learn how to monitor search performance and understand important website metrics.",
  },
];
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-base leading-8 text-slate-300 sm:text-lg">
              Learn practical search engine optimization skills through
              ...
              <div className="rounded-[24px] border border-white/10 bg-slate-900 p-6">
                ...
                <div className="mt-7 rounded-2xl border border-white/10 bg-white/[0.03] p-5">
                  ...
                  <div className="mt-7 flex h-32 items-end gap-2">
                    {[28, 38, 45, 52, 63, 70, 78, 92, 84, 97].map(
                      (height, index) => (
                        <motion.div
                          key={index}
                          initial={{ height: 0 }}
          ...
          <div className="grid items-center gap-14 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mt-5 text-base leading-8 text-slate-600 sm:text-lg">
                ...
                the fundamentals of search engine optimization and how
                online content can be improved for better visibility.
              </p>

              <p className="mt-4 text-base leading-8 text-slate-600 sm:text-lg">
                From keyword research and content optimization to
                technical SEO and analytics, learners build practical
            ...
            >
              <div className="rounded-[30px] border border-slate-200 bg-slate-50 p-7 sm:p-9">
                ...
                <h3 className="mt-7 text-2xl font-black text-slate-950">
                  Visibility. Strategy. Growth.
                </h3>

                <p className="mt-4 text-sm leading-7 text-slate-600">
                  Develop the core skills needed to understand search
                  engines, optimize digital content and track SEO
                  performance.
                </p>
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-5 text-base leading-8 text-slate-600 sm:text-lg">
              Build practical SEO skills for improving website visibility,
              content quality and search performance.
            </p>
          </motion.div>
