                ...
                <div className="rounded-2xl bg-slate-900 p-7">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3">
                    <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                      ...
                      <p className="mt-1 font-semibold">Selling</p>
                    </div>

                    <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                      <p className="text-xs text-slate-500">Approach</p>
                      <p className="mt-1 font-semibold">Practical</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20">
          <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              Learn How Online Businesses Work
            </h2>

            <p className="mt-6 text-lg leading-8 text-slate-600">
              Our e-commerce training is designed to help learners understand
              the fundamentals of selling products online and building a
              strong digital storefront.
            </p>

            <p className="mt-4 text-lg leading-8 text-slate-600">
              Learners explore Shopify, Daraz and eBay along with product
              research, listing optimization, marketing and customer
              management.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="mt-4 text-3xl font-bold text-slate-900 sm:text-4xl">
                E-Commerce Training Topics
              </h2>

              <p className="mt-5 text-lg leading-8 text-slate-600">
                Build practical skills for launching, managing and growing an
                online business.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-2xl border border-slate-200 p-7">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-600">
                  Understand the fundamentals of selling products through
              ...
              <div className="rounded-2xl border border-slate-200 p-7">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-600">
                  Learn the basics of product optimization, marketing and
      ...
      <footer className="bg-slate-950 text-white">
        <div className="mx-auto max-w-7xl border-t border-white/10 px-6 py-8 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-4 text-sm text-slate-500 md:flex-row">
            <p>
              © {new Date().getFullYear()} AicoreX Academy. All rights reserved.
            </p>
