...
const features = [
  {
    ...
    description:
      "Understand currency pairs and the basic structure of the global foreign exchange market.",
  },
  {
    icon: BarChart3,
    title: "Market Analysis",
    description:
      "Learn the fundamentals of analyzing market movements and financial information.",
  },
  {
    icon: ShieldCheck,
    title: "Risk Awareness",
    description:
      "Develop awareness of risk management and responsible participation in financial markets.",
  },
];
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-base leading-8 text-slate-300 sm:text-lg">
              Build a strong foundation in foreign exchange markets,
              currency pairs, market analysis, trading concepts and
              ...
              <div className="rounded-[24px] border border-white/10 bg-slate-900 p-6">
                ...
                <div className="mt-7 rounded-2xl border border-white/10 bg-white/[0.03] p-5">
                  ...
                  <div className="mt-7 flex h-32 items-end gap-2">
                    ...
                    {[30, 48, 40, 62, 55, 74, 67, 90, 78, 94].map(
                      (height, index) => (
                        <motion.div
                          key={index}
                          initial={{ height: 0 }}
          ...
          <div className="grid items-center gap-14 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mt-5 text-base leading-8 text-slate-600 sm:text-lg">
                Our Forex training introduces learners to the fundamentals
                of foreign exchange markets and helps them understand how
                currency markets operate.
              </p>

              <p className="mt-4 text-base leading-8 text-slate-600 sm:text-lg">
                Learners explore currency pairs, market analysis, trading
                concepts and risk management in a structured learning
                environment.
              </p>
            ...
            >
              ...
              <div className="rounded-[30px] border border-slate-200 bg-slate-50 p-7 sm:p-9">
                ...
                <p className="mt-4 text-sm leading-7 text-slate-600">
                  Develop an understanding of currency markets, analysis
                  concepts and risk awareness before making decisions in
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-5 text-base leading-8 text-slate-600 sm:text-lg">
              Develop a solid understanding of important foreign exchange
              concepts and practical market skills.
            </p>
        ...
        >
          ...
          <div className="mx-auto max-w-2xl">
            ...
            <h2 className="mt-6 text-3xl font-black tracking-tight text-white sm:text-4xl">
              Ready to Learn Forex?
            </h2>

            <p className="mt-4 text-sm leading-7 text-slate-400 sm:text-base">
              Start developing your understanding of foreign exchange
              markets through structured professional training.
            </p>
