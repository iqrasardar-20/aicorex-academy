        ...
        <section className="py-20">
          <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
              Build Your Forex Market Knowledge
            </h2>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="mt-4 text-3xl font-bold text-slate-900 sm:text-4xl">
                Forex Training Topics
              </h2>

              <p className="mt-5 text-lg leading-8 text-slate-600">
                Develop a solid understanding of important foreign
                exchange concepts and practical market skills.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-2xl border border-slate-200 p-7">
                <Globe2 size={28} className="text-blue-600" />
                ...
                <p className="mt-3 text-sm leading-6 text-slate-600">
                  Understand currency pairs and the basic structure of
